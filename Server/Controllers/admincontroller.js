...
const addDoctor = async (req, res) => {
    try {
        ...
        connection.query(insertDoctorQuery, [doctor_id, first_name, last_name, personal_email, phone_number,imageUrl, doctor_id], (err, result) => {
            if (err) {
